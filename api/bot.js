...
const dict = {
    uk: {
        ...
        help_how_desc: "ℹ️ **Як це працює**\n\n1. Напишіть назву свого міста - бот визначить координати і почне стежити за погодою саме у вашій локації.\n\n2. **Сповіщення про зміни** (проактивні):\nБот регулярно перевіряє погоду і одразу повідомляє, якщо:\n• суттєво змінився температурний прогноз на сьогодні\n• температура вже зараз аномальна (виходить за очікуваний діапазон)\n• з’явилися або скасували очікувані опади\n• погіршилася якість повітря (AQI)\n• почалася магнітна буря або сильне збурення\n\n3. **Вечірній прогноз** - щодня ви отримуєте детальний звіт на кілька днів наперед. Можна налаштувати, які саме показники показувати і на скільки днів.\n\n4. Усі сповіщення можна гнучко налаштувати:\n• окремо вимкнути непотрібні типи сповіщень про зміни\n• вимкнути вечірній прогноз\n• або вимкнути все разом\n\n5. Додатково доступні:\n• агро-аналітика та рекомендації по культурах\n• історичні дані\n• дашборд з графіками\n\nНалаштування знаходяться в меню **Налаштування**.\n\n📡 **Джерела даних:**\n• Погода — Weatherbit, Open-Meteo\n• Якість повітря — WAQI (aqicn.org), Open-Meteo\n• Магнітне поле — NOAA SWPC\n• Геокодування — OpenStreetMap Nominatim",
    ...
    en: {
        ...
        help_how_desc: "ℹ️ **How it works**\n\n1. Send the name of your city - the bot will detect the coordinates and start monitoring weather for your exact location.\n\n2. **Change Alerts** (proactive):\nThe bot regularly checks the weather and immediately notifies you if:\n• today’s temperature forecast has significantly changed\n• the current temperature is already anomalous\n• expected precipitation has appeared or been canceled\n• air quality (AQI) has deteriorated\n• a magnetic storm or strong geomagnetic disturbance has started\n\n3. **Evening Forecast** - every day you receive a detailed multi-day report. You can choose which metrics to show and for how many days.\n\n4. All notifications are fully customizable:\n• disable specific types of change alerts\n• turn off the evening forecast\n• or disable everything at once\n\n5. Additionally available:\n• agro-analytics and crop recommendations\n• historical data\n• dashboard with charts\n\nAll settings are in the **Settings** menu.\n\n📡 **Data sources:**\n• Weather — Weatherbit, Open-Meteo\n• Air quality — WAQI (aqicn.org), Open-Meteo\n• Geomagnetic — NOAA SWPC\n• Geocoding — OpenStreetMap Nominatim",
...
bot.on('callback_query', async (ctx) => {
    ...
    // --- Help topic callback ---
        ...
        // Convert Markdown italic (__) to HTML italic (<i>)
        // We do this AFTER escaping so our <b> and <i> tags remain valid
