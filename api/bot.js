...
const dict = {
    uk: {
        ...
        help_aqi_desc: "🍃 <b>ДОВІДКА: ЯКІСТЬ ПОВІТРЯ</b>\n\nНаш датчик фіксує три фракції <b>PM (Particulate Matter)</b> — це мікроскопічний твердий пил, який висить у повітрі:\n\n🔹 <b>PM₁ (до 1 мкм) — Ультрадрібний пил</b>\n• <i>Що це:</i> Найдрібніші частинки сажі, вихлопних газів авто, диму від торфовищ та промислових викидів.\n• <i>Чому небезпечно:</i> Через крихітний розмір вони проходять крізь природні фільтри легень прямо в кров, пошкоджуючи судини та серце.\n\n🔹 <b>PM₂.₅ (до 2.5 мкм) — Дрібнодисперсний пил</b>\n• <i>Норма:</i> 0–12 мкг/м³\n• <i>Що це:</i> Смог, гар від лісових пожеж, пил від тертя автомобільних шин об асфальт.\n• <i>Чому небезпечно:</i> Назавжди осідає глибоко в легенях. Найбільше шкодить дітям, вагітним та людям з астмою.\n• <i>Для тварин/рослин:</i> Собаки дихають цим інтенсивніше (пил накопичується ближче до землі). На рослинах він забиває пори, заважаючи їм дихати.\n\n🔹 <b>PM₁₀ (до 10 мкм) — Великий пил</b>\n• <i>Норма:</i> 0–45 мкг/м³\n• <i>Що це:</i> Звичайний побутовий пил, пісок, що піднімається вітром, цемент із будівництва та пилок.\n• <i>Чому небезпечно:</i> Затримується у носоглотці. Може викликати першіння в горлі, кашель та різь в очах. Важливо для алергіків у сезон цвітіння.\n\n📊 <b>РІВНІ ІНДЕКСУ AQI</b>\n\n🟢 <b>0–50 | Чисто</b>\nПовітря ідеальне. Можна довго гуляти, провітрювати дім та займатися спортом на вулиці.\n\n🟡 <b>51–100 | Помірно</b>\nПовітря прийнятне. Чутливим людям (наприклад, з важкою астмою) краще зменшити тривалі навантаження просто неба.\n\n🟠 <b>101–150 | Шкідливо для чутливих груп</b>\nДіти, літні люди та люди з хронічними хворобами дихальних шляхів можуть відчути дискомфорт. Їм краще побути в приміщенні та зачинити вікна.\n\n🔴 <b>151+ | Шкідливо для всіх</b>\nНебезпечно для кожного. Спорт на вулиці заборонений, вікна треба щільно зачинити. На вулиці рекомендується перебувати в респіраторі. Кімнатні рослини після тривалого смогу варто протирати вологою губкою.",
        help_geomag_desc: "🧲 <b>МАГНІТНІ БУРІ</b>\n\nГеомагнітна буря — це тимчасове збурення магнітного поля Землі, яке виникає внаслідок сонячних спалахів та корональних викидів маси.\n\n📡 <b>Kp-індекс</b> — основна шкала виміру сили бурі (0–9):\n\n🟢 <b>Kp 0–3 | Спокійно</b>\nМагнітне поле в нормі. Метеозалежні люди почуваються добре, прилади не збоять.\n\n🟡 <b>Kp 4 | Слабке збурення</b>\nМожливе легке погіршення самопочуття у дуже чутливих людей. Полярне сяйво видно на широтах вище 60°.\n\n🔴 <b>Kp 5–6 | Буря (G1–G2)</b>\nМетеозалежні люди можуть відчувати головний біль, стрибки тиску, безсоння. Можливі перешкоди у GPS та радіозв'язку.\n\n🔴 <b>Kp 7–9 | Сильна буря (G3–G5)</b>\nСерйозний вплив на здоров'я. Можливі збої в електромережах, відхилення компасів. Рекомендується уникати фізичних навантажень.\n\n⚕️ <b>Поради під час бурі:</b>\n• Пийте більше води.\n• Уникайте стресів та інтенсивних тренувань.\n• Тримайте під рукою ліки, якщо ви метеозалежні.\n• Рослини можуть реагувати уповільненням росту — не пересаджуйте їх в ці дні."
    },
    en: {
        ...
        help_aqi_desc: "🍃 <b>AIR QUALITY GUIDE</b>\n\nOur sensor measures three fractions of <b>PM (Particulate Matter)</b> — microscopic solid particles suspended in the air:\n\n🔹 <b>PM₁ (up to 1 µm) — Ultra-fine particles</b>\n• <i>What it is:</i> The tiniest particles of soot, car exhaust, peat smoke and industrial emissions.\n• <i>Why it's dangerous:</i> Due to their tiny size, they pass through the lungs' natural filters directly into the bloodstream, damaging vessels and the heart.\n\n🔹 <b>PM₂.₅ (up to 2.5 µm) — Fine dust</b>\n• <i>Norm:</i> 0–12 µg/m³\n• <i>What it is:</i> Smog, smoke from wildfires, dust from tyre friction on asphalt.\n• <i>Why it's dangerous:</i> Permanently settles deep in the lungs. Most harmful to children, pregnant women and people with asthma.\n• <i>For animals/plants:</i> Dogs breathe this more intensively (dust accumulates closer to the ground). On plants, it clogs pores, hindering respiration.\n\n🔹 <b>PM₁₀ (up to 10 µm) — Coarse dust</b>\n• <i>Norm:</i> 0–45 µg/m³\n• <i>What it is:</i> Ordinary household dust, wind-blown sand, construction cement and pollen.\n• <i>Why it's dangerous:</i> Trapped in the nose and throat. Can cause irritation, coughing and eye irritation. Important for allergy sufferers during pollen season.\n\n📊 <b>AQI INDEX LEVELS</b>\n\n🟢 <b>0–50 | Clean</b>\nAir is ideal. Safe for long outdoor walks, airing the home and outdoor exercise.\n\n🟡 <b>51–100 | Moderate</b>\nAir is acceptable. Sensitive individuals (e.g. with severe asthma) should reduce prolonged outdoor activity.\n\n🟠 <b>101–150 | Unhealthy for sensitive groups</b>\nChildren, elderly and people with chronic respiratory conditions may feel discomfort. Better to stay indoors and keep windows closed.\n\n🔴 <b>151+ | Unhealthy for everyone</b>\nDangerous for all. Outdoor sport is not recommended, windows should be kept tightly closed. A respirator is advised outdoors. Indoor plants should be wiped with a damp cloth after prolonged smog.",
        help_geomag_desc: "🧲 <b>MAGNETIC STORMS</b>\n\nA geomagnetic storm is a temporary disturbance of Earth's magnetic field caused by solar flares and coronal mass ejections.\n\n📡 <b>Kp-index</b> — the main scale for measuring storm intensity (0–9):\n\n🟢 <b>Kp 0–3 | Calm</b>\nMagnetic field is normal. Weather-sensitive people feel well, devices work without issues.\n\n🟡 <b>Kp 4 | Weak disturbance</b>\nPossible mild discomfort for very sensitive individuals. Aurora visible above 60° latitude.\n\n🔴 <b>Kp 5–6 | Storm (G1–G2)</b>\nWeather-sensitive people may experience headaches, blood pressure spikes, insomnia. Possible GPS and radio interference.\n\n🔴 <b>Kp 7–9 | Severe storm (G3–G5)</b>\nSerious health impact. Possible power grid disruptions and compass deviations. Avoid physical exertion.\n\n⚕️ <b>Tips during a storm:</b>\n• Drink more water.\n• Avoid stress and intense workouts.\n• Keep medication nearby if you are weather-sensitive.\n• Plants may react with slower growth — avoid repotting on these days."
    }
};
